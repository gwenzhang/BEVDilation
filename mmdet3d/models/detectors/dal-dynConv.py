...
class DAL(BEVDet):
    ...
    def forward_train(self,
        ...
        pts_feats = self.extract_pts_feat(points, img_feats, img_metas, img_feats_bev[0], temperature)
    ...
    def simple_test(self,
        ...
        img_feats_bev = \
            self.img_view_transformer(img_feats + img_inputs[1:7],
                                      depth_from_lidar=kwargs['gt_depth'])
        pts_feats = self.extract_pts_feat(points, img_feats, img_metas, img_feats_bev[0], 1)
