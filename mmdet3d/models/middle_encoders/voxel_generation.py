...
class Voxel_Generation(nn.Module):
    def __init__(self,
                ...
                fg_thr=0.4,
                expand_temp='/home/guowen/Multimodal/OpenCode_AAAI/BEVDilation/curve_template_3d_rank_8_continue_z10.pth',
                reverse_expand_temp='/home/guowen/Multimodal/OpenCode_AAAI/BEVDilation/curve_template_3d_rank_8_continue_z10_reverse.pth',
                bev_shape=(180, 180),
                voxel_size=None,
                pc_range=None,
                downstride=8,
